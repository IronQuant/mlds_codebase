...
DOMAIN_STOPWORDS = {
    "committee", "committees", "federal", "reserve", "system", "board", "fomc",
    "open", "market",
    "meeting", "meetings", "statement", "statements", "release", "released",
    "announced", "announcement", "decided", "decision", "judges", "judge",
    "seeks", "seek", "notes", "note", "continues", "continue", "met",
    "january", "february", "march", "april", "may", "june", "july", "august",
    "september", "october", "november", "december",
    "today", "recent", "recently", "currently",
    "factors", "measures", "indicators",
}
